...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ImportedContact.email'
        db.alter_column('friends_suggestions_importedcontact', 'email', self.gf('django.db.models.fields.EmailField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'ImportedContact.email'
        db.alter_column('friends_suggestions_importedcontact', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))
    ...
    models = {
        ...
        'suggestions.friendshipsuggestion': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 9, 0, 0)'}),
