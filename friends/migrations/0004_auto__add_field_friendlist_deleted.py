...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FriendList.deleted'
        db.add_column('friends_friendlist', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FriendList.deleted'
        db.delete_column('friends_friendlist', 'deleted')
    ...
    models = {
        ...
        'friends.blocking': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 29, 0, 0)'}),
        ...
        'friends.friendshipinvitation': {
            ...
            'sent': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 29, 0, 0)'}),
