...
urlpatterns += patterns('',
    ...
    url(r'^meal/(?P<meal_id>\d+)/part/remove/(?P<part_id>\w+)/$', remove_part, name='meals_meal_part_remove'),
    url(r'^meal/(?P<meal_id>\d+)/part/change/(?P<part_id>\d+)/(?P<status>\w+)/$', change_part, name='meals_meal_part_change'),
    url(r'^meal/(?P<meal_id>\d+)/part/fulfill/(?P<part_id>\d+)/$', fulfill_part, name='meals_meal_part_fulfill'),
    url(r'^meal/(?P<meal_id>\d+)/part/unfulfill/(?P<part_id>\d+)/$', unfulfill_part, name='meals_meal_part_unfulfill'),
    url(r'^meal/(?P<meal_id>\d+)/venue/add/$', add_venue, name='meals_meal_venue_create'),
    url(r'^meal/(?P<meal_id>\d+)/recipe/add/$', add_recipe, name='meals_meal_recipe_create'),
)
urlpatterns += patterns('',
    url(
