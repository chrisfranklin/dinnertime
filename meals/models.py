...
class Invite(models.Model):
    ...
    def send_email(self, from_email):
        ...
        if self.invitee.email:
            ...
            send_mail('You have been invited to a meal', 'You have been invited to a meal, to RSVP please goto http://tablesurf.in/meal/%s/invite/%s/' % (self.meal.id, self.secret), from_email, [to_email], fail_silently=False)
        else:
