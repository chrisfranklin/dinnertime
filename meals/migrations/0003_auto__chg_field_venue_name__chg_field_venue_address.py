...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('meals_venue', 'name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Venue.address'
        db.alter_column('meals_venue', 'address', self.gf('django.db.models.fields.TextField')(default=None))

    def backwards(self, orm):

        # Changing field 'Venue.name'
        db.alter_column('meals_venue', 'name', self.gf('django.db.models.fields.CharField')(default='A name!', max_length=50))

        # Changing field 'Venue.address'
        db.alter_column('meals_venue', 'address', self.gf('django.db.models.fields.TextField')(null=True))
