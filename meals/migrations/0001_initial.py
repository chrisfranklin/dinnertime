...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Venue'
        db.create_table('meals_venue', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('address', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('meals', ['Venue'])

        # Adding model 'Part'
        db.create_table('meals_part', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('part_type', self.gf('django.db.models.fields.CharField')(max_length=18)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ...
        db.send_create_signal('meals', ['Part'])

        # Adding model 'Meal'
        db.create_table('meals_meal', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=120, null=True, blank=True)),
            ('host', self.gf('django.db.models.fields.related.ForeignKey')(related_name='hosted', to=orm['auth.User'])),
            ('when', self.gf('django.db.models.fields.DateTimeField')()),
            ('icon', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('venue', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['meals.Venue'], null=True, blank=True)),
            ('max_guests', self.gf('django.db.models.fields.IntegerField')(default=4)),
            ('current_guests', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('suitable_for', self.gf('django.db.models.fields.CharField')(default='MEAT', max_length=10)),
            ('privacy', self.gf('django.db.models.fields.CharField')(default='PRIVATE', max_length=10)),
            ('recipe', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['yummly.Recipe'], null=True, blank=True)),
        ))
        db.send_create_signal('meals', ['Meal'])

        # Adding model 'MealPart'
        db.create_table('meals_mealpart', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('part', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['meals.Part'])),
            ...
            ('added_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='requested', null=True, to=orm['auth.User'])),
            ('fulfilled_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='fulfilled', null=True, to=orm['auth.User'])),
        ))
        db.send_create_signal('meals', ['MealPart'])

        # Adding model 'Invitee'
        db.create_table('meals_invitee', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('meals', ['Invitee'])

        # Adding model 'Invite'
        db.create_table('meals_invite', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('meal', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['meals.Meal'])),
            ('secret', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('invitee', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['meals.Invitee'], null=True, blank=True)),
            ('status', self.gf('django.db.models.fields.CharField')(default='INVITED', max_length=10)),
            ('plusones', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('max_plusones', self.gf('django.db.models.fields.IntegerField')(default=1, null=True, blank=True)),
            ('single_use', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('invited_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='invited_by', null=True, to=orm['auth.User'])),
        ))
        db.send_create_signal('meals', ['Invite'])

        # Adding model 'Guest'
        db.create_table('meals_guest', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('meal', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['meals.Meal'])),
            ('invite', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['meals.Invite'])),
        ))
        db.send_create_signal('meals', ['Guest'])


    def backwards(self, orm):
        # Deleting model 'Venue'
        db.delete_table('meals_venue')

        # Deleting model 'Part'
        db.delete_table('meals_part')

        # Deleting model 'Meal'
        db.delete_table('meals_meal')

        # Deleting model 'MealPart'
        db.delete_table('meals_mealpart')

        # Deleting model 'Invitee'
        db.delete_table('meals_invitee')

        # Deleting model 'Invite'
        db.delete_table('meals_invite')

        # Deleting model 'Guest'
        db.delete_table('meals_guest')
